    ...
    <div ref={rootRef} className={cn('relative flex w-full flex-col gap-1.5', className)}>
      ...
      <div className="relative">
        <input
          ...
          onKeyDown={onKeyDown}
          className={cn(
            'h-10 w-full rounded-lg border border-border bg-surface-elevated py-2 pr-9 pl-3 text-sm text-foreground',
      ...
      {isOpen && !disabled && (
        <ul
          id={listId}
          role="listbox"
          className="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-border bg-surface-elevated py-1 shadow-lg"
        >
